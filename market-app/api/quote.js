...
export default async function handler(req) {
  ...
  try {
    ...
    // 2단계: 시세 조회
    const url = `https://query1.finance.yahoo.com/v7/finance/quote?symbols=${encodeURIComponent(symbols)}&crumb=${encodeURIComponent(crumb)}&fields=regularMarketPrice,regularMarketChange,regularMarketChangePercent,shortName,longName,currency,regularMarketTime,marketState,trailingPE,marketCap`;
